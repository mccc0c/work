...
var k=a(this).index();j.find(">"+d.content+">ul>li").eq(k).show(300,function(){d.after(k,j);}).siblings().hide();return false;});}function h(k){j.find(".nav li").eq(k).addClass("current").siblings().removeClass("current");
