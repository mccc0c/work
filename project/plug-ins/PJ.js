...
function TextScroll(id, dir, number, msecs)
{
   ...
   {
      // console.log(copy.substr(1),copy[0])
...
function ColorFade(id, color1, color2, what, msecs, number, interruptible)
{
   ...
   for (var j = 0 ; j < 3 ; ++j)
   {
      ...
      // console.log(tmp,cols[j],steps[j]);
   }
...
function Lightbox(id, col1, col2, opacity, msecs)
{
   ...
   Resize('LB_DIV', getViewPort().width, getViewPort().height)
...
function CleanupStCleanupString(string, allspaces, alldigs, alltext, allpunct,
